...
public sealed class PopupForm : Form
{
    ...
    [
        ...
        [
            ...
            new("🎼", "recordar-orquestar", "llevas rato en grind serial sin delegar → sugiere fan-out (advisory)",
                "PostToolUse",
            ...
            new("🗂️", "checkpoint-mecanico", "el 80% del checkpoint a CERO tokens de modelo, andamio mecánico justo antes de compactar",
                "PreCompact",
                "Justo antes de compactar corre (detached, lock por-sid, memoria acotada en streaming) bin/checkpoint-mecanico.js sobre el transcript: extrae archivos tocados, mensajes de git commit, citas TEXTUALES del usuario y métricas de sesión sin gastar tokens de modelo, y las deja en .claude/memory/hilo-mental-actual.andamio.md (sidecar, NUNCA pisa el hilo-mental-actual.md que escribe el modelo). El skill checkpoint lo fusiona. Fail-open: sin node/jq o sin .claude/memory, no hace nada."),
            ...
            new("🔀", "hud-stale", "cambiaste de rama/proyecto → tu lista de TODOs puede ser de la tarea anterior",
            ...
            new("🧬", "proteger-fuente-cerebro", "editas la copia INSTALADA del cerebro (regenerable) → aviso",
            ...
            new("🚧", "no-bypass-deploy", "corres el instalador/deploy a mano en vez de la herramienta oficial → aviso",
                "PreToolUse · Bash",
        ...
        [
            ...
            new("🗂️", "to-do", "carga la interfaz de tareas del harness desde el backlog durable (estado-proyecto.md)",
                "skill · opt-in",
            ...
            new("🩺", "auditar-coherencia-cerebro", "fan-out READ-ONLY sobre el propio cerebro: evasiones/huecos/drift → loop hasta converger",
                "skill · opt-in",
            ...
            new("📚", "construir-missing-manual", "fabrica el manual/wiki de referencia exhaustivo que no existe (fan-out que investiga 1× y hornea) → artefacto consultable OFFLINE",
                "skill · opt-in",
            ...
            new("🔩", "ingenieria-inversa-gui-db-navegador", "ingeniería inversa de app legacy GUI+BD: driving la UI vía navegador + diff de la BD antes/después = doc con evidencia real",
                "skill · opt-in",
            ...
            new("📕", "markdown-a-pdf", "convierte .md a PDF pulido y distribuible vía md-to-pdf (npx, sin instalar) con QA visual real",
                "skill · opt-in",
